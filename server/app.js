...
<div style="width: 90%; border: 2px solid lightgreen; margin: 1rem auto; padding: 1rem; text-align: center;">
    <p style="border-bottom: 1px dashed lightgreen;margin: 0;padding-bottom: 1rem; color: lightgreen; font-size: 1.25rem;">咸鱼博客系统消息</p>
...
邮箱: ${req.body.address}
    ...
    `
    mail.send('136793214@qq.com', '您的博客有一条新留言', content, res)
    res.status(200).send('send email successfully')
})

app.listen(app.get('port'), function () {
    console.log('node服务器开启成功--地址为： http://localhost:' + app.get('port'))
})
